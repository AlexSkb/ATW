...
var enemy_scene = preload("res://char/enemy.tscn")

func _on_timer_timeout() -> void:
	var enemy = enemy_scene.instantiate() 	#stworzenie instancji klasy enemy
	enemy.position = Vector3(0, 5.646794, randi_range(10, 40))
	add_child(enemy)
	print("Utworzyłem kolejnego wroga na pozycji ", enemy.position)
